...
public class WebSecurityConfig extends WebSecurityConfigurerAdapter {
	...
	@Override
	public void configure(AuthenticationManagerBuilder authentiactionManagerBuilder) throws Exception {
		authentiactionManagerBuilder.userDetailsService(userDetailsService).passwordEncoder(passwordEncoder());
	}
